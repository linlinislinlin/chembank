#!/usr/bin/env python3
"""Curate controlled practical-topic tags for draft/9701_s25_qp_38 tagged JSON."""
import json, os
import yaml

ROOT = "/Users/tsinglan-school/Desktop/题库"
SYL = os.path.join(ROOT, "syllabus/cie-9701-as-a-level-chemistry.yaml")
TAGD = os.path.join(ROOT, "draft/9701_s25_qp_38/tagged")
...
CUR = {
 ...
 "q2": ("Thermometric experiments", 12, ["5.2"], ["5.2-1","5.2-2b"], ["practical","calculate"], 4),
 "q3": ("Qualitative analysis", 14, ["6.1","11.2"], ["6.1-3","11.2-2"], ["practical","recall"], 3),
}
n=0
