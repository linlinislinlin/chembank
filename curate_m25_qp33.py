#!/usr/bin/env python3
"""Curate controlled practical-topic tags for draft/9701_m25_qp_33 tagged JSON."""
import json, os
import yaml

ROOT = "/Users/tsinglan-school/Desktop/题库"
SYL = os.path.join(ROOT, "syllabus/cie-9701-as-a-level-chemistry.yaml")
TAGD = os.path.join(ROOT, "draft/9701_m25_qp_33/tagged")
...
CUR = {
 "q1": ("Gravimetric experiments", 11, ["2.2","2.3"], ["2.2-1","2.3-4"], ["practical","calculate"], 4),
 "q2": ("Titrations", 16, ["2.4","6.1"], ["2.4-1d","6.1-2"], ["practical","calculate"], 5),
 "q3": ("Qualitative analysis", 13, ["6.1","11.2"], ["6.1-3","11.2-2"], ["practical","recall"], 3),
}
n=0
