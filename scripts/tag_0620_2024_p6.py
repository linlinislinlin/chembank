#!/usr/bin/env python3
"""Hand-tag IGCSE 0620 2024 P6 ATP experiment blocks (0620 vocabulary)."""
...
PAPERS: dict[
    ...
    "0620_s24_qp_61": (
        ...
        61,
        {
            1: (["12.2", "12.1"], ["12.2-C1", "12.2-C2", "12.1-C1"], ["recall"], 3, "Titrations"),
            2: (["5.1", "6.2"], ["5.1-C1", "6.2-C4", "12.1-C1"], ["data-analysis"], 3, "Thermometric experiments"),
            3: (["12.5"], ["12.5-C2", "12.5-C1", "12.5-C3"], ["recall"], 3, "Qualitative analysis"),
            4: (["12.4"], ["12.4-C1", "12.4-C2"], ["evaluate"], 4, "Planning"),
        },
    ),
    "0620_s24_qp_62": (
        "MJ",
        62,
        {
            1: (["12.1", "12.5"], ["12.1-C1", "12.5-C3"], ["recall"], 3, "Gas volume experiments"),
            2: (["7.1", "12.1"], ["7.1-C4", "12.1-C1"], ["data-analysis"], 3, "Titrations"),
            3: (["12.5"], ["12.5-C1", "12.5-C2", "12.5-C4"], ["recall"], 3, "Qualitative analysis"),
            4: (["9.6", "12.4"], ["9.6-C1", "12.4-C2"], ["evaluate"], 4, "Planning"),
        },
    ),
    "0620_s24_qp_63": (
        "MJ",
        63,
        {
            1: (["12.4"], ["12.4-C1", "12.4-C2"], ["recall"], 3, "Measurement and apparatus"),
            2: (["6.2"], ["6.2-C3", "6.2-C4", "12.1-C1"], ["data-analysis"], 3, "Rate experiments"),
            3: (["12.5"], ["12.5-C1", "12.5-C2"], ["recall"], 3, "Qualitative analysis"),
            4: (["9.5", "9.3"], ["9.5-C1", "9.3-C1"], ["evaluate"], 4, "Planning"),
        },
    ),
    "0620_w24_qp_61": (
        "ON",
        ...
        {
            1: (["12.4"], ["12.4-C1", "12.4-C2"], ["recall"], 3, "Measurement and apparatus"),
            2: (["7.3", "12.1"], ["7.3-S4", "12.1-C1"], ["data-analysis"], 3, "Gravimetric experiments"),
            3: (["12.5"], ["12.5-C1", "12.5-C4"], ["recall"], 3, "Qualitative analysis"),
            4: (["12.3"], ["12.3-C1", "12.3-C2"], ["evaluate"], 4, "Planning"),
        },
    ),
    "0620_w24_qp_62": (
        "ON",
        62,
        {
            1: (["4.1"], ["4.1-C1", "4.1-C2", "4.1-C5"], ["recall"], 3, "Measurement and apparatus"),
            2: (["6.2"], ["6.2-C3", "6.2-C4"], ["data-analysis"], 3, "Rate experiments"),
            3: (["12.5"], ["12.5-C1", "12.5-C2"], ["recall"], 3, "Qualitative analysis"),
            4: (["12.2", "7.1"], ["12.2-C1", "7.1-C1"], ["evaluate"], 4, "Planning"),
        },
    ),
    "0620_w24_qp_63": (
        "ON",
        63,
        {
            1: (["7.3", "3.3"], ["7.3-S5", "3.3-S3"], ["calculate"], 4, "Gravimetric experiments"),
            2: (["5.1"], ["5.1-C1", "5.1-C2", "12.1-C1"], ["data-analysis"], 3, "Thermometric experiments"),
            3: (["12.5"], ["12.5-C2", "12.5-C1"], ["recall"], 3, "Qualitative analysis"),
            4: (["12.4", "7.2"], ["12.4-C2", "7.2-S3"], ["evaluate"], 4, "Planning"),
        },
    ),
    "0620_m24_qp_62": (
        "FM",
        62,
        {
            1: (["7.3", "12.4"], ["7.3-S4", "12.4-C1"], ["data-analysis"], 3, "Gravimetric experiments"),
            2: (["12.2", "6.2"], ["12.2-C1", "6.2-C4"], ["data-analysis"], 3, "Titrations"),
            3: (["12.5"], ["12.5-C1", "12.5-C2"], ["recall"], 3, "Qualitative analysis"),
            4: (["6.2"], ["6.2-C2", "12.4-C2"], ["evaluate"], 4, "Planning"),
        },
    ),
}
