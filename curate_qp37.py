#!/usr/bin/env python3
"""Curate controlled practical-topic tags for draft/9701_s25_qp_37 tagged JSON."""
import json, os
import yaml

ROOT = "/Users/tsinglan-school/Desktop/题库"
SYL = os.path.join(ROOT, "syllabus/cie-9701-as-a-level-chemistry.yaml")
TAGD = os.path.join(ROOT, "draft/9701_s25_qp_37/tagged")
...
CUR = {
 "q1": ("Titrations", 14, ["2.4","6.1"], ["2.4-1d","6.1-2"], ["practical","calculate"], 4),
 "q2": ("Thermometric experiments", 10, ["5.2","8.2"], ["5.2-2a","8.2-2"], ["practical","calculate"], 3),
 "q3": ("Qualitative analysis", 16, ["6.1","11.2"], ["6.1-3","11.2-2"], ["practical","recall"], 4),
}
n=0
