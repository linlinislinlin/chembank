#!/usr/bin/env python3
"""Hand-tag IGCSE 0620 2022 P6 ATP experiment blocks (0620 vocabulary)."""
...
PAPERS: dict[
    ...
    "0620_s22_qp_61": (
        ...
        61,
        {
            1: (["10.1", "12.5"], ["10.1-C1", "12.5-C3"], ["practical"], 3, "Qualitative analysis"),
            2: (["6.2", "12.1"], ["6.2-C1", "6.2-C3", "12.1-C1"], ["data-analysis"], 3, "Rate experiments"),
            3: (["12.5"], ["12.5-C2", "12.5-C1"], ["recall"], 3, "Qualitative analysis"),
            4: (["12.4"], ["12.4-C2", "12.1-C1"], ["evaluate"], 4, "Planning"),
        },
    ),
    "0620_s22_qp_62": (
        "MJ",
        62,
        {
            1: (["12.1", "12.5"], ["12.1-C1", "12.5-C3"], ["practical"], 3, "Measurement and apparatus"),
    ...
    "0620_s22_qp_63": (
        ...
        63,
        {
            1: (["10.3", "12.1"], ["10.3-C1", "12.1-C1"], ["practical"], 3, "Measurement and apparatus"),
            2: (["12.2"], ["12.2-C1", "12.2-C2"], ["data-analysis"], 3, "Titrations"),
            3: (["12.5", "10.1"], ["12.5-C4", "10.1-C1"], ["recall"], 3, "Qualitative analysis"),
    ...
    "0620_w22_qp_61": (
        ...
        61,
        {
            1: (["12.1", "12.5"], ["12.1-C2", "12.5-C3"], ["practical"], 3, "Measurement and apparatus"),
            2: (["12.1"], ["12.1-C1", "12.1-C3"], ["data-analysis"], 3, "Gravimetric experiments"),
            3: (["12.5"], ["12.5-C2", "12.5-C1"], ["recall"], 3, "Qualitative analysis"),
            4: (["12.4", "12.3"], ["12.4-C1", "12.3-C1"], ["evaluate"], 4, "Planning"),
        },
    ),
    "0620_w22_qp_62": (
        "ON",
        62,
        {
            ...
            4: (["12.1"], ["12.1-C1", "12.1-C2"], ["evaluate"], 4, "Planning"),
        },
    ),
    "0620_w22_qp_63": (
        "ON",
        63,
        {
            1: (["12.1"], ["12.1-C1", "12.1-C2"], ["practical"], 3, "Gas volume experiments"),
    ...
    "0620_m22_qp_62": (
        ...
        62,
        {
            1: (["6.2", "12.1"], ["6.2-C3", "12.1-C1"], ["practical"], 3, "Rate experiments"),
