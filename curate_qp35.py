#!/usr/bin/env python3
"""Curate controlled practical-topic tags for draft/9701_s25_qp_35 tagged JSON."""
import json, os
import yaml

ROOT = "/Users/tsinglan-school/Desktop/题库"
SYL = os.path.join(ROOT, "syllabus/cie-9701-as-a-level-chemistry.yaml")
TAGD = os.path.join(ROOT, "draft/9701_s25_qp_35/tagged")
...
CUR = {
 "q1": ("Gas volume experiments", 10, ["2.4","10.1"], ["2.4-1b","10.1-1"], ["practical","calculate"], 4),
 "q2": ("Titrations", 15, ["2.4","2.2"], ["2.4-1d","2.2-1"], ["practical","calculate"], 4),
 "q3": ("Qualitative analysis", 15, ["11.3","10.1"], ["11.3-2a","10.1-2"], ["practical","recall"], 3),
}
n=0
